...
const MapconfirmedScreenview = (props) => {
 ...
 */
    ...
    const journeyHandler = () => {
      props.navigation.navigate('Mapjourneyview', {lat: props.navigation.getParam('lat'), lng: props.navigation.getParam('lng')})
    }
    ...
    return (
        ...
        {/* <View style={styles.toggle}>
            ...
            <View style={styles.btn}>
              <Button mode="contained" onPress={journeyHandler} color="#7bf037">start journey</Button>
              </View>
...
export default MapconfirmedScreenview